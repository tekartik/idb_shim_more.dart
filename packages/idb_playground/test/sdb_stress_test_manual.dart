...
void stressMenu(SdbFactory factory, String dbName, {List<int>? addedCount}) {
  for (var count in [10, 100, 500, 800, 1000, 5000, ...?addedCount]) {
...
Future<void> main() async {
  ...
  stressMenu(factory, dbName, addedCount: [10000, 20000, 50000]);
}
